...
const projects = [
  {
    ...
    walkthrough: [
      ...
      { step: "Performance Tuning & Deployment", desc: "Used DAX Studio, Performance Analyzer, and VertiPaq Analyzer to diagnose a 10-second load time. Removed high-cardinality columns, replaced iterators with aggregators, applied VAR caching, reduced datetime cardinality by 99.97%, collapsed snowflake to star schema, and achieved sub-2-second response times — over 50% faster.", screenshot: "Performance Analyzer Results" }
    ],
    takeaways: [
